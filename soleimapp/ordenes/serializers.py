...
class ComentarioOrdenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['idcomentario', 'orden', 'usuario', 'usuario_nombre',
                  'tipo', 'texto', 'creado_at']
...
class EvidenciaOrdenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['idevidencia', 'orden', 'tipo', 'archivo', 'archivo_url',
                  'descripcion', 'subido_por', 'subido_por_nombre', 'creado_at']
        read_only_fields = ['idevidencia', 'orden', 'subido_por', 'creado_at', 'archivo_url']
...
class OrdenTrabajoSerializer(serializers.ModelSerializer):
    ...
    asignado_a_nombre = serializers.CharField(source='asignado_a.nombre', read_only=True, default=None)
    creado_por_nombre = serializers.CharField(source='creado_por.nombre', read_only=True, default=None)
    ...
    class Meta:
        ...
        fields = [
            'idorden', 'codigo',
            'instalacion', 'instalacion_nombre', 'empresa_nombre',
            'alerta', 'mantenimiento',
            'tipo', 'prioridad', 'estado',
            'titulo', 'descripcion', 'notas_resolucion',
            'asignado_a', 'asignado_a_nombre',
            'creado_por', 'creado_por_nombre',
            'sla_objetivo_horas', 'sla_vencido',
            'creada_at', 'asignada_at', 'iniciada_at', 'completada_at', 'cerrada_at',
            'tiempo_resolucion_horas',
        ]
        read_only_fields = [
            'idorden', 'codigo',
            'asignado_a', 'creado_por',
            'asignada_at', 'iniciada_at', 'completada_at', 'cerrada_at',
            'creada_at',
        ]
...
class OrdenTrabajoLigeroSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = OrdenTrabajo
        fields = [
            'idorden', 'codigo', 'titulo',
            'instalacion', 'instalacion_nombre',
            'tipo', 'prioridad', 'estado',
            'sla_objetivo_horas', 'sla_vencido',
            'creada_at', 'asignada_at',
        ]
