    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "horas_respuesta",
                    models.IntegerField(
                        default=24, help_text="SLA en horas para alertas críticas."
                    ),
                ),
                (
                    "frecuencia_preventivo_dias",
                    models.IntegerField(
                        default=30,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "frecuencia_dias",
                    models.IntegerField(
                        default=30, help_text="Cada cuántos días aplica este plan."
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tipo_sistema", "activo"], name="plan_mant_tipo_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["instalacion", "estado"], name="mant_inst_est_idx"
                    ),
                    models.Index(
                        fields=["fecha_programada", "estado"], name="mant_fecha_est_idx"
                    ),
                ],
            },
        ),
