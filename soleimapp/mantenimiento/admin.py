...
class ContratoServicioAdmin(admin.ModelAdmin):
    list_display = ('idcontrato', 'instalacion', 'nivel', 'horas_respuesta', 'activo', 'fecha_inicio', 'fecha_fin')
...
class PlanMantenimientoAdmin(admin.ModelAdmin):
    list_display = ('idplan', 'nombre', 'tipo_sistema', 'frecuencia_dias', 'duracion_estimada_horas', 'activo')
...
class MantenimientoAdmin(admin.ModelAdmin):
    list_display = ('idmantenimiento', 'instalacion', 'plan', 'fecha_programada', 'estado')
