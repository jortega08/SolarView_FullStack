...
class AlertaSerializer(serializers.ModelSerializer):
    tipo_nombre = serializers.CharField(
        source="tipoalerta.nombre", read_only=True, default="Sin tipo"
    )
    domicilio_nombre = serializers.StringRelatedField(
        source="domicilio", read_only=True
    )
    ...
    resuelta_por_nombre = serializers.CharField(
        source="resuelta_por.nombre", read_only=True, default=""
    )
