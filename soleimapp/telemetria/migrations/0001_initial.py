    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domicilio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='baterias', to='core.domicilio')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuente', models.CharField(choices=[('solar', 'Solar'), ('electrica', 'Electrica')], default='electrica', max_length=12)),
                ('costo', models.FloatField(help_text='Costo en moneda local del kwH consumido')),
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('domicilio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consumos', to='core.domicilio')),
            ],
            options={
