...
const PAGE_TITLES: Record<string, { title: string; subtitle?: string }> = {
  ...
  "/alertas": { title: "Alertas", subtitle: "Gestión de alertas activas" },
  "/ordenes": { title: "Centro de operaciones", subtitle: "Órdenes de trabajo y alertas" },
  "/mantenimiento": { title: "Mantenimiento y técnicos", subtitle: "Gestión de mantenimientos" },
  "/tecnicos": { title: "Técnicos", subtitle: "Gestión de técnicos y especialidades" },
  "/analitica": { title: "Analítica y reportes", subtitle: "Inteligencia operativa" },
